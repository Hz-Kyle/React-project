...
const Aboutus = () => {
    return (
        <>
            ...
            <div className='mb-6 flex flex-wrap mt-10 w-auto'>
                <div className='w-2/4 bg-slate-600'><img src={about} alt="signup" className='h-96 bg-cover w-full' />
                </div>
                <div className='w-2/4 p-4'>
                    <p className=' font-robotoSlap  leading-8'>Welcome to where innovation meets excellence in the world of IT services. As a leading provider of
