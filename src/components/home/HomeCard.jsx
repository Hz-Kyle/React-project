...
const HomeCard = ({ name, price, img }) => {
    ...
    return (
        <>
            <div className="max-w-sm ml-36 mt-10 bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img className="rounded-t-lg w-300" src={img} alt="" />
                </a>
                <div className="p-5">
                    <a href="#">
