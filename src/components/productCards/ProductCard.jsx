        ...
        <>
            <div className="max-w-sm bg-white border-0 font-muli  rounded-lg shadow relative gap-4">
                <Link to={`/productDetail/${id}`}>
                    <img className="rounded-t-lg object-cover h-48 w-96" src={img} />
                </Link>
                <div className="p-5 shadow-sm">
                    ...
                    <button className='font-inter border bg-primary text-white border-gray p-3 w-full'>Add to Cart</button>
                    <Link to={'/favourite'}>
                        <button className='absolute top-5 right-5 p-2 text-center  rounded-full  bg-white'>
                            <h5 className=' rounded-full hover:text-blood text-2xl'><CiHeart />
                            </h5>
                        </button>
                    </Link>
                </div>
